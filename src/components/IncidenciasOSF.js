...
class IncidenciasOSF extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            ...
            <Statistic className="menu1_symbol text_statistics" color="red" inverted size="small">
              <Statistic.Value className="number_font">103%</Statistic.Value>
              <Statistic.Label>Incidencias OSF</Statistic.Label>
