...
class MencionesTwitter extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            ...
            <Statistic className="menu1_symbol text_statistics" color="olive" inverted size="small">
              <Statistic.Value className="number_font">55</Statistic.Value>
              <Statistic.Label>Menciones Twitter</Statistic.Label>
